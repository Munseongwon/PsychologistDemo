...
import com.example.kotlinpracticeapp.databinding.FragmentResult2Binding

/**
 * A simple [Fragment] subclass.
 * Use the [SecondResultFragment.newInstance] factory method to
 * create an instance of this fragment.
 */

class SecondResultFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnBack.setOnClickListener {
            navController.navigate(R.id.action_resultFragment2_to_selectionFragment)
        }
    }
}