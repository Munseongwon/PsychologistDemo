...
import com.example.kotlinpracticeapp.databinding.FragmentResult3Binding

/**
 * A simple [Fragment] subclass.
 * Use the [ThirdResultFragment.newInstance] factory method to
 * create an instance of this fragment.
 */

class ThirdResultFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnHome.setOnClickListener {
            navController.navigate(R.id.action_resultFragment3_to_mainFragment)
        }

        binding.btnBack.setOnClickListener {
            navController.navigate(R.id.action_resultFragment3_to_selectionFragment)
        }
    }
}